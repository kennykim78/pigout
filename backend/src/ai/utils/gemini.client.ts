...
4. interaction_description: 음식과 약물의 상호작용 설명 (50자 이상)
   * 음식 성분 위주로 설명 (예: "소주의 알코올 성분이 타이레놀과 함께 섭취 시 간 손상을 유발합니다")
   * 약 자체의 설명은 제외 (예: "타이레놀은 해열진통제로..." 같은 설명 금지)

5. evidence_from_public_data: e약은요 데이터 근거 인용 (있는 경우, 음식 관련 내용만)

6. recommendation: 음식 섭취 권장사항 (30자 이상)
...
{
  "suitabilityScore": 45,
  "briefSummary": "소주는 알코올 음료로 간 건강에 부담을 줄 수 있으며 칼로리가 높아 체중 관리에 주의가 필요합니다. 현재 복용 중인 타이레놀과 함께 섭취 시 간 손상 위험이 크게 증가하므로 절대 피해야 합니다.",
  "goodPoints": ["스트레스 해소에 일시적으로 도움이 될 수 있으나 과도한 섭취는 금물입니다.", "..."],
  "badPoints": ["간 건강에 직접적인 부담을 주며 장기 섭취 시 간경화 위험이 있습니다.", "타이레놀 복용 중 알코올 섭취는 간독성을 급격히 증가시킵니다."],
  "summary": "종합적으로..."
}`;
