...
**Part 1: 핵심 분석** (expertAdvice 제외 - 중복 방지)
1. goodPoints (2-3개): 영양학적 장점만, 각 40-60자
2. badPoints (1-2개): 일반 주의사항만, 각 40-60자
3. warnings (0-2개): 심각한 경고만 (해당 시), 각 50자 이하
4. summary: 핵심 종합 분석, 100-150자
5. briefSummary: 한 줄 요약, 50자 이하

**Part 2: 섭취 가이드** (정확히 3개, 각 80-120자로 상세하게)
- healthyRecipes: [재료 대체], [조리법], [섭취 방법] 중 선택
- ${foodName} 자체를 어떻게 먹을지만 작성 (다른 음식 추천 금지)
