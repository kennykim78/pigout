        ...
        <div className="profile-setup__content">
          ...
          <div className="profile-setup__pig-section">
            <img
              src={img_main}
              alt="Pig"
              className="profile-setup__pig-image"
            />
          </div>
          ...
          <div className="profile-setup__form">
            ...
            <div className="profile-setup__input-group">
              ...
              <div className="profile-setup__input-wrapper">
                ...
                />
                {age !== null && (
                  <span className="profile-setup__age-display">({age}세)</span>
                )}
              </div>
            </div>
            ...
            <div className="profile-setup__input-group">
              ...
              <div className="profile-setup__gender-tabs">
                <button
                  type="button"
                  className={`profile-setup__gender-tab ${
                    gender === "male" ? "profile-setup__gender-tab--active" : ""
                  }`}
                ...
                <button
                  ...
                  className={`profile-setup__gender-tab ${
                    gender === "female"
                      ? "profile-setup__gender-tab--active"
                      : ""
                  }`}
            ...
            {/* 유효성 검증 오류 메시지 */}
            {validationError && (
              <div className="profile-setup__error">⚠️ {validationError}</div>
            )}
          </div>
          ...
          >
            {location.state?.fromSettings ? "수정 완료" : "다음"}
          </button>
        </div>
      </div>
    </div>
